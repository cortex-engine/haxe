 ...
 * Int64.hx - Native 64-bit integer for fiberus target
 *
 * This wraps fiberus.Int64 (native int64_t) to provide haxe.Int64 compatibility.
 */

package haxe;

private typedef __Int64 = fiberus.Int64;
...
abstract Int64(__Int64) from __Int64 to __Int64 {
	...
	// Private val accessor to avoid recursive cast issues (following HL pattern)
	...
	public static inline function toInt(x:Int64):Int {
		...
		if (x.val < -2147483648 || x.val > 2147483647)
			throw "Overflow";
		return cast x.val;
	}
	...
	public static inline function ucompare(a:Int64, b:Int64):Int {
		// Unsigned comparison: treat negative as larger (high bit set)
		if (a.val < 0)
