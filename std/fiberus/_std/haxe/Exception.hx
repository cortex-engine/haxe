...
class Exception {
	...
	public function new(message:String, ?previous:Exception, ?native:Any) {
		...
		if (native != null) {
			...
			/* Box 'this' to Dynamic: the codegen doesn't auto-box class ptrs to FibDynamic. */
			var self:Any = untyped __fiberus__("fib_dynamic_object((FibObject*)this)");
			__nativeException = self;
		}
	}
